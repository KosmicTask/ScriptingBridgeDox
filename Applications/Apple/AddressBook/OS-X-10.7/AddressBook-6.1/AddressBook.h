...
@class AddressBookApplication, AddressBookDocument, AddressBookWindow, AddressBookAddress, AddressBookContactInfo, AddressBookAIMHandle, AddressBookCustomDate, AddressBookEmail, AddressBookEntry, AddressBookGroup, AddressBookICQHandle, AddressBookInstantMessage, AddressBookJabberHandle, AddressBookMSNHandle, AddressBookPerson, AddressBookPhone, AddressBookRelatedName, AddressBookSocialProfile, AddressBookUrl, AddressBookYahooHandle;
...
enum AddressBookInstantMessageServiceType {
	AddressBookInstantMessageServiceTypeAIM = 'az85',
	AddressBookInstantMessageServiceTypeFacebook = 'az94',
	AddressBookInstantMessageServiceTypeGaduGadu = 'az86',
	AddressBookInstantMessageServiceTypeGoogleTalk = 'az87',
	AddressBookInstantMessageServiceTypeICQ = 'az88',
	AddressBookInstantMessageServiceTypeJabber = 'az89',
	AddressBookInstantMessageServiceTypeMSN = 'az90',
	AddressBookInstantMessageServiceTypeQQ = 'az91',
	AddressBookInstantMessageServiceTypeSkype = 'az92',
	AddressBookInstantMessageServiceTypeYahoo = 'az93'
};
typedef enum AddressBookInstantMessageServiceType AddressBookInstantMessageServiceType;
...
@interface AddressBookInstantMessage : AddressBookContactInfo
...
- (SBElementArray *) instantMessages;
- (SBElementArray *) socialProfiles;
...
@interface AddressBookSocialProfile : SBObject
