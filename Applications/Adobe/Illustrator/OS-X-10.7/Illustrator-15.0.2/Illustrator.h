...
@class IllustratorApplication, IllustratorDocument, IllustratorArtwork, IllustratorArtboard, IllustratorBrush, IllustratorDocumentPreset, IllustratorGradient, IllustratorGradientStop, IllustratorGradientStopInfo, IllustratorGraphicStyle, IllustratorIllustratorPreferences, IllustratorLayer, IllustratorPageItem, IllustratorCompoundPathItem, IllustratorGraphItem, IllustratorGroupItem, IllustratorLegacyTextItem, IllustratorMeshItem, IllustratorNonNativeItem, IllustratorPathItem, IllustratorPathPoint, IllustratorPathPointInfo, IllustratorPlacedItem, IllustratorPluginItem, IllustratorRasterEffectOptions, IllustratorRasterItem, IllustratorRasterizeOptions, IllustratorSymbol, IllustratorSymbolItem, IllustratorTabStopInfo, IllustratorTag, IllustratorTextFont, IllustratorTextFrame, IllustratorView, IllustratorColorInfo, IllustratorCMYKColorInfo, IllustratorGradientColorInfo, IllustratorGrayColorInfo, IllustratorLabColorInfo, IllustratorNoColorInfo, IllustratorPattern, IllustratorPatternColorInfo, IllustratorRGBColorInfo, IllustratorSpot, IllustratorSpotColorInfo, IllustratorSwatch, IllustratorSwatchgroup, IllustratorCharacter, IllustratorCharacterStyle, IllustratorInsertionPoint, IllustratorLine, IllustratorParagraph, IllustratorParagraphStyle, IllustratorStory, IllustratorText, IllustratorTextPath, IllustratorWord, IllustratorMatrix, IllustratorEllipse, IllustratorRectangle, IllustratorRoundedRectangle, IllustratorPolygon, IllustratorStar, IllustratorAutoCADOptions, IllustratorFreeHandOptions, IllustratorOpenOptions, IllustratorPDFOptions, IllustratorPhotoshopOptions, IllustratorEPSSaveOptions, IllustratorFXGSaveOptions, IllustratorIllustratorSaveOptions, IllustratorPDFSaveOptions, IllustratorAutoCADExportOptions, IllustratorFlashExportOptions, IllustratorGIFExportOptions, IllustratorImageCaptureOptions, IllustratorJPEGExportOptions, IllustratorPhotoshopExportOptions, IllustratorPNG24ExportOptions, IllustratorPNG8ExportOptions, IllustratorSVGExportOptions, IllustratorDataset, IllustratorVariable, IllustratorColorManagementOptions, IllustratorColorSeparationOptions, IllustratorCoordinateOptions, IllustratorFlatteningOptions, IllustratorFontOptions, IllustratorInk, IllustratorInkProperties, IllustratorJobOptions, IllustratorPageMarksOptions, IllustratorPaper, IllustratorPaperOptions, IllustratorPaperProperties, IllustratorPostscriptOptions, IllustratorPPDFile, IllustratorPPDProperties, IllustratorPrintOptions, IllustratorPrinter, IllustratorPrinterProperties, IllustratorScreenProperties, IllustratorScreenSpotFunction, IllustratorSeparationScreen, IllustratorTracingobject, IllustratorTracingoptions, IllustratorObsolete_properties;
...
enum IllustratorETvv {
	IllustratorETvvViewNoTracingResult = 'eTv0',
	IllustratorETvvViewOutlines = 'eTv2',
	IllustratorETvvViewOutlinesTracing = 'eTv3',
	IllustratorETvvViewTracingResult = 'eTv1'
};
typedef enum IllustratorETvv IllustratorETvv;

enum IllustratorETrv {
	IllustratorETrvViewAdjustedImage = 'eTr2',
	IllustratorETrvViewNoImage = 'eTr0',
	IllustratorETrvViewOriginalImage = 'eTr1',
	IllustratorETrvViewTransparentImage = 'eTr3'
};
typedef enum IllustratorETrv IllustratorETrv;
...
- (NSString *) doJavascript:(id)x withArguments:(NSArray *)withArguments showDebugger:(IllustratorE940)showDebugger;  // execute a javascript
...
// A document
@interface IllustratorDocument : SBObject
...
@interface IllustratorArtwork : SBObject

@property (copy) NSString *startupPreset;  // the name of startup document preset
@property (copy) IllustratorDocumentPreset *presetSettings;  // the custom document preset settings
...
// an artboard object
@interface IllustratorArtboard : SBObject
...
// A brush
@interface IllustratorBrush : SBObject
...
@interface IllustratorDocumentPreset : SBObject
...
// A gradient
@interface IllustratorGradient : SBObject
...
// A gradient stop
@interface IllustratorGradientStop : SBObject
...
@interface IllustratorGradientStopInfo : SBObject
...
// An art style
@interface IllustratorGraphicStyle : SBObject
...
@interface IllustratorIllustratorPreferences : SBObject
...
@property (copy, readonly) IllustratorFreeHandOptions *FreeHandFileOptions;  // options to use when opening or placing a FreeHand file
...
// A layer
@interface IllustratorLayer : SBObject
...
// A page item object
@interface IllustratorPageItem : SBObject
...
// A point on a path
@interface IllustratorPathPoint : SBObject
...
@interface IllustratorPathPointInfo : SBObject
...
@interface IllustratorRasterEffectOptions : SBObject
...
@interface IllustratorRasterizeOptions : SBObject
...
// A symbol
@interface IllustratorSymbol : SBObject
...
@interface IllustratorTabStopInfo : SBObject
...
@interface IllustratorTag : SBObject
...
// An installed font
@interface IllustratorTextFont : SBObject
...
// A view
@interface IllustratorView : SBObject
...
@interface IllustratorColorInfo : SBObject
...
// A pattern
@interface IllustratorPattern : SBObject
...
// A custom color
@interface IllustratorSpot : SBObject
...
// A color swatch
@interface IllustratorSwatch : SBObject
...
// A Swatch group
@interface IllustratorSwatchgroup : SBObject
...
@interface IllustratorCharacter : SBObject
...
@property (copy) IllustratorTextFont *textFont;  // the text font
...
@interface IllustratorCharacterStyle : SBObject
...
@interface IllustratorInsertionPoint : SBObject
...
@interface IllustratorLine : SBObject
...
@interface IllustratorParagraph : SBObject
...
@interface IllustratorParagraphStyle : SBObject
...
@interface IllustratorStory : SBObject
...
@interface IllustratorText : SBObject
...
// A text path item
@interface IllustratorTextPath : SBObject
...
@interface IllustratorWord : SBObject
...
@interface IllustratorMatrix : SBObject
...
@interface IllustratorEllipse : SBObject
...
@interface IllustratorRectangle : SBObject
...
@interface IllustratorRoundedRectangle : SBObject
...
@interface IllustratorPolygon : SBObject
...
@interface IllustratorStar : SBObject
...
@interface IllustratorAutoCADOptions : SBObject
...
@interface IllustratorFreeHandOptions : SBObject
...
@property BOOL importSinglePage;  // If true, only the specified page number, as set in the page to open property, will be imported (default: true)
@property NSInteger page;  // what page should be used when opening a multipage document; valid only if the import single page property is true (default: 1)
...
@interface IllustratorOpenOptions : SBObject
...
@interface IllustratorPDFOptions : SBObject
...
@interface IllustratorPhotoshopOptions : SBObject
...
@interface IllustratorEPSSaveOptions : SBObject
...
@property IllustratorEDCc compatibility;  // what Illustrator file format version to create ( default: Illustrator 15 )
...
@interface IllustratorFXGSaveOptions : SBObject
...
@interface IllustratorIllustratorSaveOptions : SBObject
...
@interface IllustratorPDFSaveOptions : SBObject
...
@interface IllustratorAutoCADExportOptions : SBObject

@property BOOL alterPathsForAppearance;  // alter paths for appearance ( default: false )
@property IllustratorEAVS AutoCADVersion;  // release of AutoCAD to export to ( default: AutoCAD release 18 )
...
@interface IllustratorFlashExportOptions : SBObject
...
@interface IllustratorGIFExportOptions : SBObject
...
@interface IllustratorImageCaptureOptions : SBObject
...
@interface IllustratorJPEGExportOptions : SBObject
...
@interface IllustratorPhotoshopExportOptions : SBObject
...
@interface IllustratorPNG24ExportOptions : SBObject
...
@interface IllustratorPNG8ExportOptions : SBObject
...
@interface IllustratorSVGExportOptions : SBObject
...
@property IllustratorESDE documentEncoding;  // how should the text in the document be encoded ( default: ASCII )
@property IllustratorEDTD DTD;  // the version of DTD that the exported file should be conforming to ( default: SVG 1.1 )
...
@property IllustratorESFS fontSubsetting;  // what font glyphs should be included in the exported file ( default: all glyphs )
@property IllustratorESFT fontType;  // the type of font that should be included in the exported file ( default: CEF font )
...
@interface IllustratorDataset : SBObject
...
@interface IllustratorVariable : SBObject
...
@interface IllustratorColorManagementOptions : SBObject
...
@interface IllustratorColorSeparationOptions : SBObject
...
@interface IllustratorCoordinateOptions : SBObject
...
@interface IllustratorFlatteningOptions : SBObject
...
@interface IllustratorFontOptions : SBObject
...
// printer's ink
@interface IllustratorInk : SBObject
...
// Ink information
@interface IllustratorInkProperties : SBObject
...
@interface IllustratorJobOptions : SBObject
...
@interface IllustratorPageMarksOptions : SBObject
...
// paper size
@interface IllustratorPaper : SBObject
...
// the paper options
@interface IllustratorPaperOptions : SBObject
...
// Paper information
@interface IllustratorPaperProperties : SBObject
...
@interface IllustratorPostscriptOptions : SBObject
...
// a PPD file
@interface IllustratorPPDFile : SBObject
...
@interface IllustratorPPDProperties : SBObject
...
// the print options
@interface IllustratorPrintOptions : SBObject
...
@interface IllustratorPrinter : SBObject
...
// printer information
@interface IllustratorPrinterProperties : SBObject
...
// Screen information
@interface IllustratorScreenProperties : SBObject
...
@interface IllustratorScreenSpotFunction : SBObject
...
@interface IllustratorSeparationScreen : SBObject
...
// A tracing object.
@interface IllustratorTracingobject : SBObject

@property (copy, readonly) NSNumber *bestType;  // the best type for the object's value
@property (copy, readonly) NSNumber *defaultType;  // the default type for the object's value
@property (copy) NSDictionary *properties;  // all of this object's properties returned in a single record
@property (readonly) NSInteger anchorCount;  // The number of anchors in the tracing result.
@property (readonly) NSInteger areaCount;  // The number of areas in the tracing result.
@property (copy, readonly) SBObject *container;  // the object's container
@property (readonly) double imageResolution;  // The resolution of the source image (in pixels per inch).
...
@interface IllustratorTracingoptions : SBObject

@property (copy, readonly) NSNumber *bestType;  // the best type for the object's value
@property (copy, readonly) NSNumber *defaultType;  // the default type for the object's value
@property (copy) NSDictionary *properties;  // all of this object's properties returned in a single record
@property (copy, readonly) SBObject *container;  // the object's container
@property double cornerAngle;  // Corner angle.
@property BOOL fills;  // Tracing with fills.  At least one of Fills and Strokes must be on.
@property BOOL ignoreWhite;  // Controls whether to ignore white fill color.
@property BOOL livePaintOutput;  // Controls whether result art is LivePaint or classic art.
@property NSInteger maximumColors;  // The number of colors allowed for automatic palette generation.
@property double maximumStrokeWeight;  // Maximum stroke weight (stroke only).
@property NSInteger minimumArea;  // Minimum area.
@property double minimumStrokeLength;  // Minimum stroke length (stroke only).
@property BOOL outputSwatches;  // Controls whether named colors (swatches) are generated.
@property (copy) NSString *palette;  // The color palette used for tracing, empty string indicates automatic palette.
@property double pathFitting;  // Path fitting.
@property double preprocessBlur;  // The blur amount during preprocessing.
@property (copy, readonly) NSString *preset;  // The preset name use.  Read-only.
@property BOOL resample;  // The resampling control.
@property double resampleResolution;  // The resampling resolution.
@property BOOL strokes;  // Tracing with strokes.  At least one of Fills and Strokes must be on.
@property NSInteger threshold;  // The threshold value for a black and white tracing. ( 0 - 255 )
@property IllustratorETMt tracingMode;  // The tracing mode: color, gray, black and white.
@property IllustratorETrv viewRaster;  // The raster visualization mode.
@property IllustratorETvv viewVector;  // The vector visualization mode.
...
- (BOOL) storePresetPresetname:(NSString *)presetname;  // Store options to a preset.  Will overwrite an existing (unlocked) preset if names match.
